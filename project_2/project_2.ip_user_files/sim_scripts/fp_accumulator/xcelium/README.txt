...
#
# Generated by export_simulation on Thu Jun 02 21:34:45 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fp_accumulator.sh' script.

./fp_accumulator.sh -reset_run
...
./fp_accumulator.sh -noclean_files

For more information on the script, please type './fp_accumulator.sh -help'.
