...
#
# Generated by Vivado on Thu Jun 02 21:34:45 +0800 2022
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: fp_accumulator.sh [-help]
# usage: fp_accumulator.sh [-lib_map_path]
# usage: fp_accumulator.sh [-noclean_files]
# usage: fp_accumulator.sh [-reset_run]
#
...
# executing this script. Please type 'fp_accumulator.sh -help' for more information.
#
...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm xbip_utils_v3_0_9 axi_utils_v2_0_5 xbip_pipe_v3_0_5 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_5 xbip_dsp48_multadd_v3_0_5 xbip_bram18k_v3_0_5 mult_gen_v12_0_14 floating_point_v7_1_7)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "fp_accumulator.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../project_2.srcs/sources_1/ip/fp_accumulator/sim/fp_accumulator.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_accumulator xil_defaultlib.glbl -o fp_accumulator_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp_accumulator_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fp_accumulator.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fp_accumulator_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fp_accumulator_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fp_accumulator.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: fp_accumulator.sh [-help]\n\
Usage: fp_accumulator.sh [-lib_map_path]\n\
Usage: fp_accumulator.sh [-reset_run]\n\
Usage: fp_accumulator.sh [-noclean_files]\n\n\
