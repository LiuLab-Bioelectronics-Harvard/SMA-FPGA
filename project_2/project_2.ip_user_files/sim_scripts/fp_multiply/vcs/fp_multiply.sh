...
#
# Generated by Vivado on Thu Jun 02 21:34:56 +0800 2022
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: fp_multiply.sh [-help]
...
# executing this script. Please type 'fp_multiply.sh -help' for more information.
#
...
# Script info
echo -e "fp_multiply.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../project_2.srcs/sources_1/ip/fp_multiply/sim/fp_multiply.vhd" \
  2>&1 | tee -a vhdlan.log
...
reset_run()
{
  files_to_remove=(ucli.key fp_multiply_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fp_multiply_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fp_multiply.sh -help\" for more information)\n"
    exit 1
  fi
