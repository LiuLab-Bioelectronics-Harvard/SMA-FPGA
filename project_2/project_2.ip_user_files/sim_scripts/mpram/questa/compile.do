...
vlog -work xilinx_vip -64 -sv -L axi_vip_v1_1_4 -L processing_system7_vip_v1_0_6 -L smartconnect_v1_0 -L axi_protocol_checker_v2_0_4 -L axi_protocol_checker_v2_0_1 -L axi_vip_v1_1_1 -L processing_system7_vip_v1_0_3 -L xilinx_vip "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
...
vlog -work generic_baseblocks_v2_1_0 -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
"../../../../project_2.srcs/sources_1/bd/mpram/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0 -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
"../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_18 -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
"../../../../project_2.srcs/sources_1/bd/mpram/ipshared/cc23/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_3 -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
...
vlog -work axi_data_fifo_v2_1_17 -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
"../../../../project_2.srcs/sources_1/bd/mpram/ipshared/c4fd/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_19 -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
"../../../../project_2.srcs/sources_1/bd/mpram/ipshared/6c9d/hdl/axi_crossbar_v2_1_vl_rfs.v" \

vlog -work xil_defaultlib -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
"../../../bd/mpram/ip/mpram_xbar_0/sim/mpram_xbar_0.v" \

vlog -work blk_mem_gen_v8_3_6 -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
...
vlog -work blk_mem_gen_v8_4_2 -64 "+incdir+../../../../project_2.srcs/sources_1/bd/mpram/ipshared/ec67/hdl" "+incdir+D:/Xilinx/vivado2018/Vivado/2018.3/data/xilinx_vip/include" \
