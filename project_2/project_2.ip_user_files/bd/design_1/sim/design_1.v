...
module design_1
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 emio_gpio TRI_I" *) input [2:0]emio_gpio_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 emio_gpio TRI_O" *) output [2:0]emio_gpio_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 emio_gpio TRI_T" *) output [2:0]emio_gpio_tri_t;
  ...
  assign BRAM_PORTB_0_1_DIN = bram_portb_din[31:0];
  assign BRAM_PORTB_0_1_EN = bram_portb_en;
  assign BRAM_PORTB_0_1_RST = bram_portb_rst;
  assign BRAM_PORTB_0_1_WE = bram_portb_we[3:0];
  assign bram_portb_dout[31:0] = BRAM_PORTB_0_1_DOUT;
  assign emio_gpio_tri_o[2:0] = processing_system7_0_GPIO_0_TRI_O;
  assign emio_gpio_tri_t[2:0] = processing_system7_0_GPIO_0_TRI_T;
  assign processing_system7_0_GPIO_0_TRI_I = emio_gpio_tri_i[2:0];
