...
HD_PWD='E:/Debug_V2.3/ZYNQ_CALC/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_top.tcl -notrace
