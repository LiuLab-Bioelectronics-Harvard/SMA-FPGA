...
HD_PWD='E:/Debug_V2.3/ZYNQ_CALC/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_top.tcl
